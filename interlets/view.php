...
function show_legend(){
	...
	echo "<br>* De API key moet je aanvragen bij de beheerder van de andere installatie, het is een sleutel die je eigen Marva toelaat om met de andere eLAS/Marva te praten";
	...
	echo "<br>* Remote LETS code is de letscode waarmee deze installatie bij de andere groep bekend is, deze moet aan de andere kant aangemaakt zijn";
        ...
        echo "<br>* SOAP URL is de locatie voor de communicatie tussen Marva en het andere systeem, voor een andere eLAS/Marva is dat de URL met /soap erachter";
